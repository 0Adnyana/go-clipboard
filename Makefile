...
.PHONY: help db-create db-reset migrate generate test lint dev check-dev-tools
...
generate: ## Regenerate sqlc code from db/queries (never edit generated files by hand)
	$(SQLC) generate
